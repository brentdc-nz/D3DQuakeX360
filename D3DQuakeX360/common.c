...
void COM_Init (const char *basedir)
{
	...
	*/
	...
	Con_Printf("Checking system byte order...\n");
	...
	if (bigendien == false)
	{
		...
		Con_Printf("Using little endien.\n");
	}
...
{
	// TODO : WIll do once render is working fully
}
