...
#ifndef _XBOX // We use MP3 via libmad
	CDAudio_Update();
#endif
...
void Host_Init (quakeparms_t *parms)
{
	...
	if (cls.state != ca_dedicated)
	{
		...
		Chase_Init();
		M_Init ();
//		ExtraMaps_Init (); //johnfitz // TODO : WIll do once render is fully working
//		Modlist_Init (); //johnfitz // TODO : WIll do once render is fully working
		VID_Init ();
#ifndef _XBOX		
...
#if 0 //def _XBOX // TODO : Move to cfg file!
		Cbuf_InsertText ("bind \"XBOX_START\" \"togglemenu\"\n"
