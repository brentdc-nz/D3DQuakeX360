...
{
	// TODO: Will do once the render is fully working
}
...
void ExtraMaps_NewGame (void)// TODO: Will do once render is fully working
{
//	ExtraMaps_Clear ();
//	ExtraMaps_Init ();
}
...
{
	// TODO: Will do once render is fully working
}
